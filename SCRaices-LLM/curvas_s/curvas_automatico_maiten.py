...
# Curva S programada semanal El Maiten (32 semanas = 224 días por vivienda)
...
BENEFICIARIOS_SETUP = [
    # ── GRUPO 1 ──
    ("GRUPO 1", "CARRILLO MILLAVIL ALBERTO SEGUNDO",    "11/05/2026"),
    ("GRUPO 1", "CHIHUAILAF QUILAQUEO CLAUDIA TAMARA",  "11/05/2026"),
    ("GRUPO 1", "LOPEZ MARTINEZ GUILLERMO ERNESTO",     "18/05/2026"),
    ("GRUPO 1", "LIENQUEO JARAMILLO JOSE AVELINO",      "25/05/2026"),
    # ── GRUPO 2 ──
    ("GRUPO 2", "VIDAL SUAZO ELSA NELLY",               "08/06/2026"),
    ("GRUPO 2", "DUMULEF ALIANTE JOSE RAFAEL",          "08/06/2026"),
    ("GRUPO 2", "ESPINOZA MENIL JUAN LEONIDAS",         "15/06/2026"),
    ("GRUPO 2", "DUMULEF MILLANAO LIDIA DEL CARMEN",    "15/06/2026"),
    ("GRUPO 2", "MARTINEZ CHANDIA DAGOBERTO ORLANDO",   "22/06/2026"),
    # ── GRUPO 3 ──
    ("GRUPO 3", "VALDEBENITO MELLADO ENOMISIA DEL CARMEN", "29/06/2026"),
    ("GRUPO 3", "LINEROS FUENTES ERICA ISABEL",         "29/06/2026"),
    ("GRUPO 3", "CATRILEO LEFIMIL JUAN BAUTISTA",       "06/07/2026"),
    ("GRUPO 3", "ILLESCA PENA LORNA GLADYS",            "06/07/2026"),
    ("GRUPO 3", "REYES REYES MARIA ANGELICA",           "13/07/2026"),
    ("GRUPO 3", "ARAVENA RAINAO MARTA",                 "13/07/2026"),
    # ── GRUPO 4 ──
    ("GRUPO 4", "SMITH ERNST ALEX ROBERTO",             "27/07/2026"),
    ("GRUPO 4", "PILQUIAN LLANCACURA FIDELINA ELIANA",  "27/07/2026"),
    ("GRUPO 4", "HUENCHUFIL SILVA ROLANDO ALFREDO",     "03/08/2026"),
    # ── GRUPO 5 ──
    ("GRUPO 5", "HUILCAN LEFIN JOSE ESTEBAN",           "10/08/2026"),
    ("GRUPO 5", "HUILCAN LEFIU JUAN SEGUNDO",           "10/08/2026"),
    ("GRUPO 5", "BARAHONA QUILAQUEO MARIA LUISA",       "17/08/2026"),
    ("GRUPO 5", "AZOCAR BRAVO NORMA ESTER",             "17/08/2026"),
    # ── GRUPO REZAGADOS ──
    ("GRUPO REZAGADOS", "AGUAYO PARRA JORGE HERNAN",              "24/08/2026"),
    ("GRUPO REZAGADOS", "ALIANTE DUMULEF JUAN ALFONSO",           "31/08/2026"),
    ("GRUPO REZAGADOS", "ANTILAF PICHUN DELIA LUISA",             "31/08/2026"),
    ("GRUPO REZAGADOS", "CADIN CADIN JOSE HERNESTO",              "07/09/2026"),
    ("GRUPO REZAGADOS", "CONA LINCON ALBERTO CAYUMAN",            "14/09/2026"),
    ("GRUPO REZAGADOS", "GARCES SOLDADO TERESA",                  "14/09/2026"),
    ("GRUPO REZAGADOS", "PAINEMILLA HUARAPIL CARMEN RITA",        "14/09/2026"),
]
...
def actualizar_drive(drive_svc, outdir, drive_ids=None):
    return _ccu.actualizar_drive_organizado(drive_svc, outdir, CHART_NAMES, OBRA_FOLDER, "maiten")
