"""
curvas_automatico_peumayen.py  -  Automatizacion semanal Curvas S - Proyecto Peumayen 2023 (P123)
==================================================================================================
- Fecha de control:  date.today() (automatica)
- Datos de avance:   leidos desde AppSheet (proyecto P123)
  Fallback:          hoja 'Datos Control' del spreadsheet Gantt Control Peumayen 2023
- Genera 8 graficos PNG (6 grupos + total + todos grupos)
- Actualiza Drive, marca PENDIENTE para Apps Script

Ejecucion manual:  python curvas_automatico_peumayen.py
"""
...
# CONFIGURACION
# ─────────────────────────────────────────────────────────────────────────────
SPREADSHEET_ID = "1EEQF-RqP9DKosnaedwL79dXD9GXwBY8S8idkjF5S-2I"
APPSHEET_PROJECT = "P123"
TOKEN_FILE     = _ccu.TOKEN_FILE
OBRA_FOLDER    = "Peumayen"
...
DPI_EXPORT   = 200
DRIVE_IDS_FILE = None  # gestionado por _ccu

# Curva S programada semanal Peumayen 2023 (35 semanas = 245 dias)
# Linear: 36 puntos alcanzando 100% en 35 semanas
PCT_SEMANA = [round(i * 100 / 35, 2) for i in range(36)]
DURACION_DIAS = 245
...
CHART_NAMES = [
    "CurvaS_GRUPO_1_Peumayen.png",
    "CurvaS_GRUPO_2_Peumayen.png",
    "CurvaS_GRUPO_3_Peumayen.png",
    "CurvaS_GRUPO_4_Peumayen.png",
    "CurvaS_GRUPO_5_Peumayen.png",
    "CurvaS_GRUPO_6_Peumayen.png",
    "CurvaS_TOTAL_Peumayen.png",
    "CurvaS_Todos_Grupos_Peumayen.png",
]

BENEFICIARIOS_SETUP = [
    # GRUPO 1
    ("GRUPO 1", "SILVIA ISABEL HUENUPI SAAVEDRA",          "09/11/2026"),
    ("GRUPO 1", "ROSA PAILLACHEO LLANQUIN",                 "09/11/2026"),
    ("GRUPO 1", "ELIZABETH FERNANDA ANCAO QUIJÓN",          "16/11/2026"),
    ("GRUPO 1", "BERNARDO RAIN MANQUEO",                    "16/11/2026"),
    ("GRUPO 1", "IGNACIA DEL CARMEN LEMUNAO PREÑAN",        "23/11/2026"),
    # GRUPO 2
    ("GRUPO 2", "MARÍA CECILIA PIUTRÍN RAIN",               "30/11/2026"),
    ("GRUPO 2", "CLAUDIA FERNANDA RAIN PIUTRIN",            "30/11/2026"),
    ("GRUPO 2", "DEISY YUDITH MANQUEO TRANAMIL",            "07/12/2026"),
    ("GRUPO 2", "ERNESTO RAIN RAÑILEO",                     "07/12/2026"),
    ("GRUPO 2", "AMELIA DEL CARMEN MANQUEO EPUÑAN",         "14/12/2026"),
    ("GRUPO 2", "IDANIA RAIN RAIN",                         "14/12/2026"),
    # GRUPO 3
    ("GRUPO 3", "FIDEL ANIÑIR MILLANAO",                    "21/12/2026"),
    ("GRUPO 3", "ALBERTO EDUARDO PILCOL BEÑA",              "21/12/2026"),
    ("GRUPO 3", "WALDO HUICHAPAN HUICHAPAN",                "28/12/2026"),
    ("GRUPO 3", "RAÚL HERNÁN MALLEO AÑIHUAL",               "28/12/2026"),
    ("GRUPO 3", "MARIO CELESTINO MALLEO AÑIHUAL",           "04/01/2027"),
    ("GRUPO 3", "HIPÓLITO BERNARDINO HUILCÁN MALLEO",       "04/01/2027"),
    ("GRUPO 3", "SARA SAAVEDRA LEMUÑIR",                    "11/01/2027"),
    ("GRUPO 3", "JUAN ALFREDO PICHULAF MILLAPI",            "11/01/2027"),
    ("GRUPO 3", "NELSON ROBERTO HUILCÁN PICHULAF",          "18/01/2027"),
    ("GRUPO 3", "PEDRO SAMUEL PICHULAF HUINCA",             "18/01/2027"),
    # GRUPO 4
    ("GRUPO 4", "ERNESTO JESÚS ALAN CATRIAN",               "25/01/2027"),
    ("GRUPO 4", "MARIANA LISSETTE CARIMÁN ALCÁNTARA",       "25/01/2027"),
    ("GRUPO 4", "SEBASTIÁN HUENUL MILLAMÁN",                "01/02/2027"),
    ("GRUPO 4", "OSCAR ROSALINO SILVA DE LA FUENTE",        "01/02/2027"),
    ("GRUPO 4", "OMAR ENRIQUE SILVA DE LA FUENTE",          "08/02/2027"),
    ("GRUPO 4", "FRANCISCO JAVIER COLICOY NECULQUEO",       "08/02/2027"),
    ("GRUPO 4", "CRISTIAN ORLANDO REDEL ALMENDRA",          "15/02/2027"),
    ("GRUPO 4", "JOEL SEGUNDO SEPÚLVEDA TOLOZA",            "15/02/2027"),
    ("GRUPO 4", "LORENZO HUENUL MARIN",                     "22/02/2027"),
    # GRUPO 5
    ("GRUPO 5", "JESICA ALEJANDRA MELIPIL MILLA",           "01/03/2027"),
    ("GRUPO 5", "EMILIO JAVIER QUINTANA HUALLA",            "01/03/2027"),
    ("GRUPO 5", "FRANCISCA QUINTANA HUALLA",                "08/03/2027"),
    ("GRUPO 5", "GUICELA HAIDE QUINTANA PACHECO",           "08/03/2027"),
    ("GRUPO 5", "ABNER NEFTALÍ QUINTANA PACHECO",           "15/03/2027"),
    ("GRUPO 5", "RUFINO FERMÍN CATRIÁN CATRIÁN",            "15/03/2027"),
    ("GRUPO 5", "MARÍA JUANA LIPIAN LEMUÑIR",               "22/03/2027"),
    # GRUPO 6
    ("GRUPO 6", "IGNACIA EUGENIA RUPAYAN CATRILEO",         "29/03/2027"),
    ("GRUPO 6", "MOISÉS SEGUNDO RUPAYÁN CATRILEO",          "29/03/2027"),
    ("GRUPO 6", "JUAN PABLO HUENTIAN HUENTIAN",             "05/04/2027"),
    ("GRUPO 6", "BERTA ELENA HUENTIAN CATRIÁN",             "05/04/2027"),
    ("GRUPO 6", "ANTONIETA ISABEL TRANGOL CATRÍAN",         "12/04/2027"),
    ("GRUPO 6", "MÓNICA DEL CARMEN MARCOS RUPAYAN",         "12/04/2027"),
]

# ─────────────────────────────────────────────────────────────────────────────
# LOG
# ─────────────────────────────────────────────────────────────────────────────
log = _ccu.setup_logging("peumayen")
...
def _load_drive_ids():
    return _ccu.load_drive_ids("peumayen_2023", {})


def _save_drive_ids(ids):
    _ccu.save_drive_ids("peumayen_2023", ids)


def sincronizar_grupos_desde_gantt(sheets_svc):
    """Sincroniza grupos y fechas de inicio desde 'Programa de obra' hacia 'Datos Control'.
    Columna D (idx 3): nombre/grupo; columna K (idx 10): inicio."""
    log.info("Verificando movimientos de grupo en 'Programa de obra' (Peumayen)...")

    r = sheets_svc.spreadsheets().values().get(
        spreadsheetId=SPREADSHEET_ID,
        range="'Programa de obra'!A1:L65",
    ...
    for row in prog_rows:
        ...
        if not nombre_raw or not grupo_actual:
            continue
        # Filtrar filas que no son beneficiarios
        skip_words = ("BENEFICIARIO", "CARTA GANTT", "CORRE.", "PROGRAMA", "", "CANT", "RUT")
        if nombre_raw.upper() in skip_words or nombre_raw[0].isdigit():
            continue
        try:
...
def leer_avance_appsheet():
    if not APPSHEET_DISPONIBLE:
        ...
        return None
    try:
        log.info(f"Leyendo avance desde AppSheet {APPSHEET_PROJECT} (Peumayen)...")
...
def leer_datos_control(sheets_svc):
    """Lee 'Datos Control' de Peumayen. % real = AppSheet P123 (o col D como fallback)."""
    ...
    for row in rows[4:]:
        ...
        # Parsear inicio: serial Excel, DD/MM/YYYY, MM/DD/YYYY, YYYY-MM-DD, DD-MM-YYYY
...
def generar_grafico_grupo(nombre_grupo, beneficiarios, control, outdir, pct_prog_gantt=None):
    ...
    if 0 <= idx_ctrl < len(prog):
        _diff  = pct_real_avg - pct_prog_ctrl
        _signo = "+" if _diff >= 0 else ""
        _xytext_x = control + timedelta(days=21)
        _xytext_y = max(5, pct_prog_ctrl + 8)
        ax.annotate(
            f"Prog: {pct_prog_ctrl:.1f}%\nReal: {pct_real_avg:.1f}%\nDesv: {_signo}{_diff:.1f}%",
            xy=(control, pct_prog_ctrl),
            xytext=(_xytext_x, _xytext_y),
    ...
    ax.set_title(
        f"Curva S - {nombre_grupo} - Peumayen 2023 P123 ({len(beneficiarios)} viviendas)\n"
    ...
    fname = Path(outdir) / f"CurvaS_{slug}_Peumayen.png"
...
def generar_grafico_total(grupos, control, fines_proy_global, outdir, pct_prog_gantt_total=None):
    ...
    if 0 <= idx_ctrl_total < len(prog_total):
        prog_en_ctrl = (pct_prog_gantt_total if pct_prog_gantt_total is not None
                        else prog_total[idx_ctrl_total])
    ...
    ax2.set_title(
        f"Curva S Total - Peumayen 2023 P123 ({len(todos)} viviendas)\n"
    ...
    plt.tight_layout()
    fname_total = Path(outdir) / "CurvaS_TOTAL_Peumayen.png"
...
def generar_grafico_todos(grupos, control, fines_proy_global, outdir):
    ...
    ax3.set_title(
        "Curva S por Grupo - Peumayen 2023 P123\n"
    ...
    plt.tight_layout()
    fname = Path(outdir) / "CurvaS_Todos_Grupos_Peumayen.png"
    plt.savefig(fname, dpi=DPI_EXPORT, bbox_inches="tight"); plt.close()
    log.info(f"  Grafico guardado: {fname.name}")


# ─────────────────────────────────────────────────────────────────────────────
# 5. REDIMENSIONAR (desactivado)
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# 6. INSERTAR IMAGENES EN HOJA 'Curva S'
# ─────────────────────────────────────────────────────────────────────────────
def insertar_imagenes_en_sheets(sheets_svc, drive_ids):
    """Actualiza formulas IMAGE() en hoja 'Curva S': 2 cols x 4 filas."""
    log.info("Actualizando formulas IMAGE() en hoja 'Curva S' Peumayen...")

    meta = sheets_svc.spreadsheets().get(spreadsheetId=SPREADSHEET_ID).execute()
    curvas_gid = None
    for s in meta["sheets"]:
        if s["properties"]["title"] == "Curva S":
            curvas_gid = s["properties"]["sheetId"]
            break
    if curvas_gid is None:
        log.error("Hoja 'Curva S' no encontrada.")
        return

    W_PX, H_PX = 755, 385
    layout = [
        ("CurvaS_GRUPO_1_Peumayen.png",       0, 0),
        ("CurvaS_GRUPO_2_Peumayen.png",        1, 0),
        ("CurvaS_GRUPO_3_Peumayen.png",        0, 1),
        ("CurvaS_GRUPO_4_Peumayen.png",        1, 1),
        ("CurvaS_GRUPO_5_Peumayen.png",        0, 2),
        ("CurvaS_GRUPO_6_Peumayen.png",        1, 2),
        ("CurvaS_TOTAL_Peumayen.png",          0, 3),
        ("CurvaS_Todos_Grupos_Peumayen.png",   1, 3),
    ]
...
def actualizar_drive(drive_svc, outdir, drive_ids=None):
    return _ccu.actualizar_drive_organizado(drive_svc, outdir, CHART_NAMES, OBRA_FOLDER, "peumayen_2023")
...
def actualizar_pct_en_hoja(sheets_svc, grupos):
    """Escribe % real actualizados en 'Datos Control' col D. OBLIGATORIO: round(pct, 2)."""
    valores = []
...
def main():
    ...
    log.info("=" * 65)
    log.info(f"INICIO CURVAS S PEUMAYEN 2023  -  {ts}")
    log.info("=" * 65)
    ...
    try:
        ...
        log.info("Generando graficos Peumayen 2023...")
        fines_proy_global = []
        for nombre_grupo, beneficiarios in grupos.items():
        ...
        # Insertar/actualizar imagenes en hoja 'Curva S'
        insertar_imagenes_en_sheets(sheets_svc, drive_ids)

        # Marcar pendiente (Apps Script actualizara las imagenes en Sheets)
